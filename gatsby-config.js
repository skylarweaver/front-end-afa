  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        headers: {
          "/*": [
            `Content-Security-Policy-Report-Only: default-src 'none'; form-action 'none'; frame-ancestors 'none'; style-src 'self' 'unsafe-line' https://fonts.googleapis.com; script-src 'self' https://www.google-analytics.com https://js.stripe.com; img-src 'self' data: blob: https://www.google-analytics.com ; child-src blob: ; worker-src blob: ; connect-src 'self' https://*.tiles.mapbox.com https://api.mapbox.com https://api.stripe.com ; frame-src https://js.stripe.com https://hooks.stripe.com; manifest-src 'self';`,
          ],
