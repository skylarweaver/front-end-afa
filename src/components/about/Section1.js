          ...
          // >
            <ContentLayout top={[3, 3, 4]} className={className}>
              ...
              <Box width={[1, 1, 1 / 2]} p={[0, 1, 1]}>
                ...
                <p>
                  With an affinity for travel, and having fallen in love with each Latin American country Skylar has visited thus far, a motorcycle trip from the USA to Argentina has been a dream of his for years. But he wanted the trip to be bigger than just him. To have a greater purpose. Riding a motorcycle a few thousand miles across continents is one thing, but changing lives along the way—that’s the real goal. 
                  <br></br>
                  <br></br>
